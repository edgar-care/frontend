...
import onSubmitSignup from 'utils/connection/onSubmitSignup';
	...
	return (
		<VStack w="100%" maxW="500px" spacing="32px">
			<FormControl isRequired isInvalid={emailError}>
				...
				/>
				{emailError && (
					<FormErrorMessage id="edgar-signupPage-formEmailError-text">Adresse mail invalide</FormErrorMessage>
				)}
			</FormControl>
