...
import AddTreatmentPeriodInputs from 'components/dashboardPages/treatments/AddTreatmentPeriodInputs';
import AddTreatmentCommentInputs from 'components/dashboardPages/treatments/AddTreatmentCommentInputs';
