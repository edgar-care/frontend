	...
	return (
		<HStack spacing="8px">
			<Menu defaultIsOpen>
				...
				<MenuList>
					<MenuItem onClick={() => onFilterChange('newest')}>{getIcon('newest')} Plus récent</MenuItem>
					<MenuItem onClick={() => onFilterChange('oldest')}>{getIcon('oldest')} Plus ancien</MenuItem>
					<MenuItem onClick={() => onFilterChange('asc')}>{getIcon('asc')} Tri alphabétique</MenuItem>
					<MenuItem onClick={() => onFilterChange('desc')}>{getIcon('desc')} Tri antialphabétique</MenuItem>
				</MenuList>
			</Menu>
		</HStack>
	);
