...
import HealthIssueInfoDrawer from 'components/dashboardPages/medical/modal/forms/medical/healthIssues/HealthIssueInfoDrawer';
...
const HealthIssueCard = ({
	...
	healthIssue: PatientMedicalAntecedentType;
	isDeletable: boolean;
	onClick?: () => void;
}): JSX.Element => {
