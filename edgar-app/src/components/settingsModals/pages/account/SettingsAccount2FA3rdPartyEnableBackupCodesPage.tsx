...
const SettingsAccount2FA3rdPartyEnableBackupCodesPage = (
	...
	return {
		headerTitle: 'La double authentification avec une application tierce est activée !',
		headerSubtitle:
...
export default SettingsAccount2FA3rdPartyEnableBackupCodesPage;
