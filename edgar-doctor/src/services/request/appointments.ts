...
import { type AppointmentsStoreType } from 'store/types/appointments.type';
...
export const { useGetDoctorAppointmentsQuery, useLazyGetDoctorAppointmentsQuery } = extendedApi;
