...
const AddPatientModalWeightInput = ({
	...
	<VStack spacing="8px" align="start" w="100%">
		<FormLabel size="boldLg" id="edgar-addPatientModal-formWeight-text">
			Poids
		</FormLabel>
		<Input
			{...register('medicalFolder.weight', { valueAsNumber: true, min: 2, max: 300, required: true })}
			placeholder="45kg"
			type="number"
			w="100%"
			step="0.01"
