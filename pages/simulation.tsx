...
const Simulation = (): JSX.Element => (
	<VStack spacing="32px" paddingTop="32px">
		...
		<Stack spacing="96px">
			<Stack spacing="8px">
				<Text fontWeight={700} fontSize="32px" marginTop={100}>
					Bienvenue sur edgar.care
				</Text>
				<Text fontWeight={700} as="b" fontSize="20px" marginTop={0}>
					Votre assistant medical
				</Text>
			</Stack>
			<Stack spacing="48px">
				<Text fontWeight={700} fontSize="28px">
					Vous allez commencer votre analyse
				</Text>
